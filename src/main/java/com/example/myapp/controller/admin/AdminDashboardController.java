...
public class AdminDashboardController {
    ...
    @GetMapping("/summary")
    @Operation(summary = "Get dashboard summary: users, orders, revenue")
    public ResponseEntity<DashboardSummaryResponse> getSummary() {
        DashboardSummaryResponse resp = adminDashboardService.getSummary();
...
// {
// List<DashboardTopCategoryResponse> response =
...
// List<DashboardTopCountryResponse> response =
...
// public ResponseEntity<List<DashboardTopPaymentMethodResponse>>
// getTopPaymentMethods() {
// List<DashboardTopPaymentMethodResponse> response =
// dashboardService.getTopPaymentMethods();
// return ResponseEntity.ok(response);
// }
...
// List<DashboardTopProductResponse> response =
...
// List<DashboardTopCommentResponse> response =
// dashboardService.getTopComments();
// return ResponseEntity.ok(response);
// }
